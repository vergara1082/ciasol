...
public class CiaInfracciones  implements java.io.Serializable {
    ...
    public CiaInfracciones(BigDecimal infId, CiaPersonas ciaPersonas, CiaUsuarios ciaUsuarios, String infCodigo, String infFactura, BigDecimal infEstado) {
        this.infId = infId;
    ...
    public CiaInfracciones(BigDecimal infId, CiaPersonas ciaPersonas, CiaUsuarios ciaUsuarios, String infCodigo, Date infFecha, String infFactura, BigDecimal infEstado, Date infFechaEstado, String infNumero, Set ciaDetalleCursoses) {
       this.infId = infId;
       this.ciaPersonas = ciaPersonas;
       this.ciaUsuarios = ciaUsuarios;
       this.infCodigo = infCodigo;
